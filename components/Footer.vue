    ...
    <div class="container-custom py-12 md:py-16">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-1">
          <NuxtLink
            to="/"
            class="flex items-center gap-2 text-xl font-bold mb-4"
          >
            <span class="text-foxen-500">Foxen</span>
            <span class="text-gray-300">Digital</span>
          </NuxtLink>
          <p class="text-gray-400 text-sm">
            Quality web development, open source values. Specialists in Laravel,
            Vue.js, and Agentic Engineering.
          </p>
        </div>
      ...
      <div class="mt-12 pt-8 border-t border-gray-800 text-center">
        <p class="text-gray-500 text-sm">
          &copy; {{ new Date().getFullYear() }} Foxen Digital. All rights
          reserved.
        </p>
      </div>
    </div>
