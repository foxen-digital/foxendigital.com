    ...
    <div class="container-custom py-12 md:py-16">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-1">
          <NuxtLink to="/" class="flex items-center gap-2 text-xl font-bold mb-4">
            <span class="text-foxen-500">Foxen</span>
            <span class="text-gray-300">Digital</span>
          </NuxtLink>
          <p class="text-gray-400 text-sm">
            Quality web development, open source values. Specialists in Laravel, Vue.js, and Agentic Engineering.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li v-for="link in quickLinks" :key="link.href">
              <NuxtLink :to="link.href" class="text-gray-400 hover:text-white transition-colors">
                {{ link.label }}
              </NuxtLink>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li v-for="link in socialLinks" :key="link.href">
              <a :href="link.href" target="_blank" rel="noopener" class="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
        ...
        <div>
          ...
          <a href="mailto:hello@foxendigital.co.uk" class="text-foxen-400 hover:text-foxen-300 text-sm">
            hello@foxendigital.co.uk
          </a>
        </div>
      </div>
      ...
      <div class="mt-12 pt-8 border-t border-gray-800 text-center">
        <p class="text-gray-500 text-sm">
          &copy; {{ new Date().getFullYear() }} Foxen Digital. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
