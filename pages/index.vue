  ...
  <div>
      ...
      <div class="container-custom relative z-10">
        <div class="max-w-4xl">
          <h1 class="heading-1 mb-6">
            ...
            <span class="text-foxen-500">As Hard As You Do</span>
          </h1>
      ...
      <div class="container-custom">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="bg-gray-800/50 rounded-xl p-8 border border-gray-700/50">
            ...
            <h3 class="heading-3 mb-3">Built in the UK</h3>
          ...
          <div class="bg-gray-800/50 rounded-xl p-8 border border-gray-700/50">
            ...
            <h3 class="heading-3 mb-3">Open by Default</h3>
            <p class="text-gray-400">
          ...
          <div class="bg-gray-800/50 rounded-xl p-8 border border-gray-700/50">
            ...
            <h3 class="heading-3 mb-3">Quality First</h3>
            <p class="text-gray-400">
              We'd rather do fewer things exceptionally well than many things mediocre. Every project gets our full attention and expertise.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
          <div class="group p-8 rounded-xl border border-gray-800 hover:border-gray-700 transition-colors">
            ...
            <p class="text-gray-400 mb-4">
              Bespoke web applications tailored to your business needs. From internal tools to customer-facing platforms, we build solutions that scale.
            </p>
          ...
          <div class="group p-8 rounded-xl border border-gray-800 hover:border-gray-700 transition-colors">
            ...
            <p class="text-gray-400 mb-4">
              Specialists in the Laravel ecosystem. API development, package creation, performance optimisation, and long-term maintenance.
            </p>
            <NuxtLink to="/services" class="text-foxen-400 hover:text-foxen-300 text-sm font-medium">
              Learn more →
            </NuxtLink>
          ...
          <div class="group p-8 rounded-xl border border-gray-800 hover:border-gray-700 transition-colors">
            ...
            <p class="text-gray-400 mb-4">
              We create and maintain open source packages that help developers work smarter. Browse our contributions on GitHub.
            </p>
            <NuxtLink to="/open-source" class="text-foxen-400 hover:text-foxen-300 text-sm font-medium">
              View packages →
            </NuxtLink>
          </div>
    ...
    <section class="section-padding">
      <div class="container-custom text-center">
        <h2 class="heading-2 mb-4">Ready to Build Something Great?</h2>
        <p class="text-gray-400 max-w-2xl mx-auto mb-8">
          Whether you have a fully-formed idea or just a problem that needs solving, we'd love to chat.
        </p>
